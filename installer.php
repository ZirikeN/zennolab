...
namespace {
    ...
    class InstallerBootstrapData {
        const ARCHIVE_FILENAME       = '20241025_zennolabjournal_62aa1d95d47342554702_20241025080249_archive.zip';
        const ARCHIVE_SIZE           = '307061577';
        const INSTALLER_DIR_NAME     = 'dup-installer';
        const PACKAGE_HASH           = '62aa1d9-25080249';
        const SECONDARY_PACKAGE_HASH = '12224ea-25080249';
        const VERSION                = '4.5.19.1';
    }
